        ...
        <div class="row">
            <div class="col-xl-4">
                <div class="card profile-greeting">
                    <img src="{{asset('assets/images/foto/').'/'.$anak->foto_anak}}" class="card-img-top" alt="...">
                </div>
                <div class="card ">
                    <a href="{{route('proses_verifikasi', $anak->id_anak) }}" class="btn btn-primary">Verifikasi</a>
                </div>
            </div>
            <div class="col-xl-8">
                <form class="card">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-3 row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">Alamat Sekolah</label>
                                    <div class="col-sm-9">
                                        <input type="text" readonly class="form-control-plaintext" id="staticEmail" value='@if($anak->status_anak == 1)
                                        Yatim
