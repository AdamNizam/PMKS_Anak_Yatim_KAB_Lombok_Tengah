                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate="" action="{{route('verifikator.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="mb-3 row">
                                            <input type="hidden" id="id_userlog" name="id_userlog" value="{{Session::get('id_userlog')}}">
                                            <label for="username" class="col-sm-3 col-form-label">Username</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" id="username" type="text" name="username" autocomplete="off" value="{{Session::get('username')}}">
                                                @error('username')
