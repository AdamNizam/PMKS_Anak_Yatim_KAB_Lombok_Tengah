                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 mt-5">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="needs-validation" novalidate="" action="<?php echo e(route('survior.store')); ?>" method="post" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        <div class="mb-3 row">
                                            <input type="hidden" id="id_userlog" name="id_userlog" value="<?php echo e(Session::get('id_userlog')); ?>">
                                            <label for="username" class="col-sm-3 col-form-label">Username</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" id="username" type="text" name="username" autocomplete="off" value="<?php echo e(Session::get('username')); ?>">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="email form-control" id="email" type="text" name="email" autocomplete="off">
...
</html><?php /**PATH D:\APPLaravel\pmks-yatim\resources\views/survior/formadd.blade.php ENDPATH**/ ?>