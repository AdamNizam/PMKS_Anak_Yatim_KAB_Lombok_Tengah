...
<?php $__env->startSection('title'); ?>Prestasi Formal <?php echo e($title); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($formal->id_prestasi_formal); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="/prestasi/formal/<?php echo e($formal->id_prestasi_formal); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
<script>
    $(function() {
        ...
        $('.tombol-ubah').on('click', function() {
            ...
            $('.form-ubah form').attr('action', '/prestasi/formal/' + id)
            // console.log(id);

            $.ajax({
                url: `/prestasi/formal/` + id + `/edit`,
                method: 'get',
                dataType: 'json',
                success: function(data) {
                    // console.log(data)
                    $('#id_ubah').val(data.id_prestasi_formal)
                    $('#formal_ubah').val(data.prestasi_formal)
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/superadmin/prestasi_formal/index.blade.php ENDPATH**/ ?>