...
<?php $__env->startSection('title'); ?>Role <?php echo e($title); ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($role->id_role); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="/user/role/<?php echo e($role->id_role); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
            ...
            <form action="<?php echo e(route('role.store')); ?>" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 draggable">
                        ...
                        <input class="form-control btn-square <?php $__errorArgs = ['role'];
...
unset($__errorArgs, $__bag); ?>" id="role" name="role" type="text" placeholder="Role" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" id="role_ubah" name="role_ubah" type="text" placeholder="Role" required autocomplete="off">
                        <?php $__errorArgs = ['title_ubah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/superadmin/role/index.blade.php ENDPATH**/ ?>