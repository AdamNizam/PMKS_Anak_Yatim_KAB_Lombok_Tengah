...
<?php $__env->startSection('title'); ?>Pendidikan <?php echo e($title); ?>
                    ...
                    <div class="dt-ext table-responsive">
                        <table class="display" id="basic-1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td><?php echo e($pendidikan->pendidikan); ?></td>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-warning btn-square tombol-ubah" type="button" data-bs-toggle="modal" data-original-title="test" data-bs-target="#tomboUbah" data-id="<?php echo e($pendidikan->id_pendidikan); ?>"><i class="fa fa-edit"></i></button>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="/pendidikan/pendidikan/<?php echo e($pendidikan->id_pendidikan); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/superadmin/pendidikan/index.blade.php ENDPATH**/ ?>