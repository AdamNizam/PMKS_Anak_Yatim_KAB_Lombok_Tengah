                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('detail_survior', $row->id_survior)); ?>" class="btn btn-sm btn-info btn-square " data-id=""><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo e(route('anak.edit', $row->id_survior)); ?>" class="btn btn-sm btn-warning btn-square" data-id=""><i class="fa fa-edit"></i></a>
                                        <form onsubmit="return confirm('Are You Sure ?');" action="/anak/anak/<?php echo e($row->id_survior); ?>" method="POST" class="d-inline ">
                                            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/superadmin/survior.blade.php ENDPATH**/ ?>