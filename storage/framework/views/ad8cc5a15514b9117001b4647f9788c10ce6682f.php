        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown"><a class="nav-link menu-title link-nav <?php echo e(routeActive('anak')); ?>" href="<?php echo e(route('anak')); ?>"><i data-feather="users"></i><span>Anak</span></a></li>
