  ...
  $(document).ready(function() {
    $.ajax({
      ...
      success: function(data) {
        ...
        valueAxis.min = 0;
        valueAxis.max = data['anak'].length;
...
<?php echo $__env->make('layouts.verifikator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/verifikator/index.blade.php ENDPATH**/ ?>