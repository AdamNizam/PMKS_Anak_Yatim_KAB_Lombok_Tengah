        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/anak')); ?>" href="javascript:void(0)"><i data-feather="users"></i><span>Anak</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/anak')); ?>;">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title <?php echo e(prefixActive('/rekapan')); ?>" href="javascript:void(0)"><i data-feather="book"></i><span>Rekapan</span></a>
                        <ul class="nav-submenu menu-content" style="display: <?php echo e(prefixBlock('/rekapan')); ?>;">
...
</header><?php /**PATH D:\APPLaravel\pmks-anak-yatim\resources\views/layouts/survior/partials/sidebar.blade.php ENDPATH**/ ?>